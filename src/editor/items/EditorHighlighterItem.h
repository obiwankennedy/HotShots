...
#ifndef _EDITORHIGHLIGHTERITEM_H_
#define _EDITORHIGHLIGHTERITEM_H_

#include "BaseItem.h"

class QGraphicsLineItem;

class EditorHighlighterItem : public BaseItem
{
    Q_OBJECT
...
public:
    ...
    EditorHighlighterItem(QGraphicsItem *parent = 0);
    virtual ~EditorHighlighterItem();
...
#endif // _EDITORHIGHLIGHTERITEM_H_
